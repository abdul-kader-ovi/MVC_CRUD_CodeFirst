...
using MVCCodeFirst_TrainingAcademySln.Models.ViewModel;
using MVCCodeFirst_TrainingAcademySln.Repositories;
using PagedList;
using System;
...
namespace MVCCodeFirst_TrainingAcademySln.Controllers
{
    ...
    public class StudentsController : Controller
    {
        ...
        public ActionResult ExportReport()
        {
            ...
            return File(stream, "apllication/xls", "Student.xls");
        }
